...
public class SignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Signout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SignIn.this, "SignOut Sucessfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void beginRecovery(String email)
    {
        objectfirebaseauth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(SignIn.this, "Recovery Email is send", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(SignIn.this, "Could'nt send Recovery Email", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(SignIn.this, "Failed to recover"+e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void convertxmltojava()
    {
        ...
        objectprogressbar=findViewById(R.id.progressBar);
...
//                        objectprogressbar.setVisibility(View.VISIBLE);
                        ...
                        objectfirebaseauth.signInWithEmailAndPassword(emailET.getText().toString(),
                            ...
                            public void onSuccess(AuthResult authResult) {
                                Toast.makeText(SignIn.this, "Sucessfully Sign In", Toast.LENGTH_SHORT).show();
                            ...
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(SignIn.this, "Unsucessfull to Signin", Toast.LENGTH_SHORT).show();
